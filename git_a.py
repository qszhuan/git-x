...
def init_parser():
    parser = argparse.ArgumentParser(description=info('Description: Add file contents to the index specified in pathspec, remove file contents if specified in <--exclude>'),
                                     epilog='')
